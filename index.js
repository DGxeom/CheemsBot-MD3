...
XeonBotInc.sendFileFromUrl = async(link, type, options) => {
hasil = await getBuffer(link)
XeonBotInc.sendMessage(from, hasil, type, options).catch(e => {
fetch(link).then((hasil) => {
XeonBotInc.sendMessage(from, hasil, type, options).catch(e => {
XeonBotInc.sendMessage(from, { url : link }, type, options).catch(e => {
reply
console.log(e)
})
})
